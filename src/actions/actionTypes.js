...
const actions = {
    BUY_STOCK: "BUY_STOCK", // BUY STOCK
    SELL_STOCK: "SELL_STOCK", // SELL STOCK
    SEARCH_STOCK: "SEARCH_STOCK", // LOOKUP STOCK ON THE MARKET
	UPDATE_CHART: "UPDATE_CHART", // UPDATES THE CHARTED STOCK
    ...
    GET_USER_PORTFOLIO: "GET_USER_PORTFOLIO", // GETS USERS PORTFOLIO
    ...
    OPEN_WEB_SOCKET: "OPEN_WEB_SOCKET", // OPENS THE WEBSOCKET ON RETURN OF USER PORTFOLIO
    STOCK_DATA_RECEIVED: "STOCK_DATA_RECEIVED", // PASSES INCOMING WEBSOCKET INFO ON THE THE REDUCER
    GET_GLOBAL_CONTESTANTS: "GET_GLOBAL_CONTESTANTS",
}
